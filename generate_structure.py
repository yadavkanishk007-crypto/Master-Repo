...
for all public GitHub repositories of a given user.
"""
...
USERNAME = "yadavkanishk007-crypto"
...
class GitHubClient:
    ...
    def fetch_repos(self) -> list:
        repos, page = [], 1
        log.info("Fetching repositories for: %s", self.username)

        while True:
            response = self.session.get(
                f"{API_BASE}/users/{self.username}/repos",
...
"""
    ...
    def write_main_readme(repos: list) -> None:
        ...
        with open("README.md", "w", encoding="utf-8") as f:
            f.write(content)
        log.info("Main README.md written (%d repos)", len(repos))
